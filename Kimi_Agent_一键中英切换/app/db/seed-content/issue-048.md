Every map of Chinese battery globalization shows the same two anchors: Europe, where CATL 宁德时代's Debrecen sold out before it switched on, and America, where access is written in legislation. Then there is Southeast Asia — the part of the map nobody draws. It is not a market. It is an export platform: factories that ship to Europe, the Middle East and Africa without ever crossing a Chinese or European border. In Thailand, BYD 比亚迪 has spent a year shipping cars to Germany from a plant meant for Bangkok's commuters. In Malaysia, EVE 亿纬锂能 quietly turned Kulim into a two-track battery base. In Indonesia, BYD's Subang plant is weeks from starting production built for export. This issue explains how the platform works — and the two ways Chinese capital is getting into the one market that will not take its factories.
