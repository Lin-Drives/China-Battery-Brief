...
The scaffolding around the fund matters as much as the money. In May 2025 the China Society of Automotive Engineers issued T/CSAE 434-2025, the world's first group standard defining the判定方法 — the determination method — for all-solid-state batteries. That sounds pedantic until you realize its function: it draws a legal line between "all-solid-state" and the semi-solid products already on the road, preventing marketing inflation from contaminating the subsidy pipeline. Add local funds (Zhuhai RMB 5bn, Shanghai RMB 3bn) and NDRC ultra-long-term bonds subsidizing solid-state projects at roughly 15% of investment, and the message to the six anointed players is clear: 2027 is a deadline set by the state, not just by press releases.
...
| Company | Route | 2027 commitment | Density target | The fine print |
|---|---|---|---|---|
| CATL | Sulfide | Small-batch production | ~500 Wh/kg | Full commercialization "before 2030" |
| BYD | Sulfide | Demo fleet, thousands of vehicles | 400 Wh/kg (60Ah pilot cell, 2024) | Cost parity with liquid ~2030, at 40,000 vehicles |
| SAIC/QingTao | Semi → all-solid | Mass delivery target | >400 Wh/kg, >820 Wh/L | Anting line commissioned late 2025; prototypes testing 2026 |
| FAW/Hongqi | Sulfide | Flagship mass production | n/a | Demo car off line after 470-day program |
| Toyota/Idemitsu | Sulfide | "Mass production" 2027–28 | 1,000-km range claim | Has delayed twice before; some trackers say limited production 2026 |

The second tier sings from the same sheet. GAC has built what CCTV describes as its first large-capacity all-solid-state line (400 Wh/kg) but is in small-scale testing, with gradual mass production framed as 2027–2030. Chery's "Rhino S" module targets first vehicle validation in 2027, Changan scaled mass production the same year. Among the cell makers, Gotion's "Gemstone" runs a 0.2 GWh pilot line at a reported ~90% yield, Farasis is targeting GWh-scale output in 2026, and EVE launched its Longquan No. 3/4 all-solid-state program early this year. Samsung SDI talks 2027 pilot, SK On 2029, VW/QuantumScape has shipped QSE-5 B-samples. Everyone is on schedule — for a schedule that peaks at samples.
...
The reasons LFP holds above 55%:

1. **The cost gap is structural.** Solid-state's sulfide electrolytes and dry-room processing are nowhere near LFP's learning curve. Even BYD dates parity to ~2030.
2. **Fast charging neutralized LFP's weakest flank.** CATL's second-generation Shenxing (April 2025) delivers a 12C peak rate, over 1.3 MW peak power, and 520 km per five-minute charge. BYD's Super e-Platform (March 2025) claims megawatt flash charging — later reporting describes 1,500 kW peak and 10–97% in nine minutes on LMFP-evolved Blade cells. When an LFP-family pack charges in minutes, the energy-density argument does a lot less work.
3. **LFP has a second engine: storage.** Roughly 90% of the US BESS market used Chinese LFP cells in 2024, and Ford is now licensing CATL LFP for a 20 GWh/yr stationary-storage line. Stationary storage does not care about gravimetric density at all.
4. **The chemistry is still improving.** LMFP is the defined upgrade path, and high-compaction-density LFP is reportedly in undersupply as fast-charging competition intensifies — with 2025 demand estimated near 800 kt.
