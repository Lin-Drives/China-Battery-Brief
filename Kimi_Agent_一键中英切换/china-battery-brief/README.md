...
> 交付版本：`85f6de9` · 2026-08-03 · 全栈（React 19 + Hono/tRPC + Drizzle/MySQL）
...
| `/risk` | 风险雷达 | `risk.scores` + `policy.list` | 动画风险仪表（86/78/62/54）、12 条政策时间线（2023→2027）、国家敞口卡 |
...
- `content.*`：issues.list/latest/bySlug（**权限感知截断**）、factories.list/stats、policy.list、risk.scores、ticker.items、subscribe.email
