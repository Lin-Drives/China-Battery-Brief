...
10. **拒绝翻译腔**：中文必须是自然的编辑书面语。典型问题与改法：
    - 语义矛盾误用：「腰斩 85%」错（腰斩=减半），应为「暴跌/下降 85%」。
    - 直译套话：「把形状画了出来」→「画出了这幅轮廓」；「答案有一个名字，值得说准确一点」→「理由很具体，不是……而是……」；「吃满市场风险」→「自己扛下市场风险」；「关闭债务融资」→「撬动那笔融资」。
    - 英文已经词有惯译就中文化，不中英夹杂堆英文：toll→过网费、market sounding→市场询价、grid-forming→电网构型。
    - 长定语堆砌时断句，避免语序悬空（介词短语「为它……」不置句首，主谓先行）。
